...
### Funcionalidades desejadas ( API EM EXECUÇÃO : http://3.22.68.96:8082 )
...
* * Exemplo para a requisição  http://3.22.68.96:8082/pessoas/gastos?param=camila
- Listar 3 tarefas que estejam sem pessoa alocada com os prazos mais antigos. (get/tarefas/pendentes)
* * Exemplo para a requisição http://3.22.68.96:8082/tarefas/pendentes
